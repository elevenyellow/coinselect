...
merge(results)
  .sort((a, b) => {
    if (a.stats.transactions !== b.stats.transactions)
      return b.stats.transactions - a.stats.transactions
  ...
  .forEach((x, i) => {
    ...
    console.log(
      ...
      pad(stats.name),
      "| transactions",
      pad("" + stats.transactions),
      "| fee",
      pad("" + stats.average.fee),
      "| feeRate",
      pad("" + stats.average.feeRate),
      "| nInputs",
      pad(stats.average.nInputs),
      "| nOutputs",
      pad(stats.average.nOutputs),
      "| DNF",
      (100 * DNF).toFixed(2) + "%",
      "| totalCost",
      pad("" + Math.round(stats.totalCost / 1000)),
      "| utxos",
      pad("" + stats.utxos)
    )
  })
